var colorBackground = "#1AA478";                           // Hintergrundfarbe
var colorTrack = "#ffc040";                                // Farbe f�r Fahrbahn
var colorStop = "#ff0000";                                 // Farbe f�r Prellbock
var colorGlider = "#0000ff";                               // Farbe f�r Gleiter
var colorScale1 = "#000000";                               // Farbe 1 f�r Lineal
var colorScale2 = "#00ff00";                               // Farbe 2 f�r Lineal
var colorLB = "#000000";                                   // Farbe f�r Lichtschranke
var colorClock1 = "#808080";                               // Farbe f�r Uhr (Geh�use)
var colorClock2 = "#000000";                               // Farbe f�r Uhr (Anzeige)
var colorClock3 = "#ff0000";                               // Farbe f�r Uhr (Ziffern)
